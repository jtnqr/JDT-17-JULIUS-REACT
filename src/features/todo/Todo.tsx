...
export default function Todo() {
	...
	useEffect(() => {
		document.title = "Task Manager | JDT-17 Page";
	}, []);
	...
	return (
		<div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col items-center justify-center px-4 py-16 relative overflow-hidden">
