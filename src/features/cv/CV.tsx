...
const SKILLS: Skill[] = [
	...
	{ name: "ElysiaJS", category: "frameworks" },
	{ name: "Next.js", category: "frameworks" },
	{ name: "React", category: "frameworks" },
	{ name: "Tailwind CSS", category: "frameworks" },
	{ name: "DaisyUI", category: "frameworks" },
	...
	{ name: "LanceDB", category: "databases" },
	...
	{ name: "Linux (Debian/Ubuntu)", category: "devops" },
	{ name: "SSH", category: "devops" },
	{ name: "UFW", category: "devops" },
...
export default function CV() {
	...
	return (
		<div className="min-h-screen bg-zinc-950 text-zinc-150 flex flex-col items-center justify-start px-4 py-16 relative overflow-hidden">
			...
			<div className="w-full max-w-4xl relative z-10">
				...
				<div className="flex items-center justify-between mb-8">
					<Button
						asChild
						variant="ghost"
						className="text-zinc-400 hover:text-zinc-150 hover:bg-zinc-900 group gap-1.5 rounded-xl"
					>
						<Link to="/">
							<svg
						...
						<div className="space-y-6">
							...
							<div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
								{filteredSkills.map((skill) => (
									<Card
										key={skill.name}
										className="border border-zinc-850/60 bg-zinc-900/10 hover:border-amber-500/20 hover:bg-zinc-900/30 rounded-xl p-3.5 flex flex-col justify-between transition-all duration-300 hover:-translate-y-0.5"
									>
										<span className="text-sm font-bold text-zinc-150">{skill.name}</span>
										<Badge
											variant="secondary"
											className="mt-2.5 border-transparent text-[9px] uppercase font-bold tracking-wider py-0.5 px-2 bg-zinc-950/40 text-zinc-500"
										>
											{skill.category === "devops" ? "DevOps & Tools" : skill.category}
										</Badge>
									</Card>
								))}
							</div>
