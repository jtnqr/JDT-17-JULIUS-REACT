	...
	if (isLoading) {
		return (
			<div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col justify-between">
				{/* Shimmer Header */}
				<div className="h-16 border-b border-zinc-900 bg-zinc-950 animate-pulse" />
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 lg:grid-cols-3 gap-12 w-full flex-1">
				...
				<header className="sticky top-0 z-50 w-full border-b border-zinc-900/60 bg-zinc-950/80 backdrop-blur-md">
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
						<Link to="/" className="flex items-center gap-3 group">
							<span className="h-8 w-8 rounded-lg bg-amber-500 flex items-center justify-center text-zinc-950 font-black text-base group-hover:scale-105 transition-transform duration-300">
								PH
							</span>
							<span className="font-bold text-lg tracking-tight text-zinc-50">PilemHub</span>
						</Link>
						<Button asChild variant="ghost" className="text-zinc-400 hover:text-zinc-50">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
					...
					<nav aria-label="Module navigation" className="flex items-center gap-2">
						<Button
							asChild
							variant="ghost"
							className="text-zinc-400 hover:text-zinc-50 hover:bg-zinc-900/40 px-3 py-2 rounded-xl text-sm font-semibold"
						>
