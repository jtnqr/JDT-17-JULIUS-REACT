...
const SearchVisibilityContext = createContext<{
	...
	setHasInPageSearch: (visible: boolean) => void;
}>({
	hasInPageSearch: false,
	setHasInPageSearch: () => {},
});

export const useInPageSearch = () => useContext(SearchVisibilityContext);
...
export default function MovieLayout() {
	...
	return (
		<SearchVisibilityContext.Provider value={{ hasInPageSearch, setHasInPageSearch }}>
