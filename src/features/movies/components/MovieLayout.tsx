		...
		<div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col justify-between">
			...
			<header className="sticky top-0 z-50 w-full border-b border-zinc-900/60 bg-zinc-950/80 backdrop-blur-md">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
					...
					{/* Center/Right Nav Link (Back to Hub) */}
					<div className="flex items-center gap-2 sm:gap-4 shrink-0">
						<Button
							asChild
							variant="ghost"
							className="text-zinc-400 hover:text-zinc-50 hover:bg-zinc-900/40 px-2.5 py-2 rounded-xl text-xs sm:text-sm font-semibold gap-1"
						>
							<Link to="/">
								<svg
									className="w-4 h-4"
								...
								<span className="hidden md:inline">Hub Portal</span>
							</Link>
						</Button>
					</div>
