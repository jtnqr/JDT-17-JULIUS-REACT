...
export default function About() {
	...
	return (
		<div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col items-center justify-center px-4 py-8 sm:py-16 relative overflow-hidden">
			...
			<div className="w-full max-w-xl relative z-10">
				...
				<div className="flex items-center justify-between mb-8">
					<Button
						asChild
						variant="ghost"
						className="text-zinc-450 hover:text-zinc-100 hover:bg-zinc-900 group gap-1.5 rounded-xl"
					>
						<Link to="/">
							<svg
					...
					<CardContent className="p-0 space-y-4">
						...
						<div className="grid grid-cols-2 gap-4">
							<div className="flex flex-col p-3 rounded-xl border border-zinc-850/60 bg-zinc-950/20">
								...
								<span className="text-sm font-medium text-zinc-200">{user.firstName || "n/a"}</span>
							</div>
							<div className="flex flex-col p-3 rounded-xl border border-zinc-850/60 bg-zinc-950/20">
								<span className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider mb-1">
									Last Name
								</span>
								<span className="text-sm font-medium text-zinc-200">{user.lastName || "n/a"}</span>
							</div>
						</div>
