	...
	return (
		<div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col justify-between relative overflow-hidden">
			...
			<main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-16 flex flex-col justify-center">
				...
				{/* Sleek GitHub CTA Section */}
				<div className="mt-16 max-w-5xl mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-300">
					<div className="relative overflow-hidden rounded-2xl border border-zinc-800/80 bg-linear-to-r from-zinc-900/10 via-zinc-900/40 to-zinc-900/10 p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 group hover:border-amber-500/20 transition-all duration-300">
						<div className="absolute inset-0 -z-10 bg-linear-to-r from-amber-500/2 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
						<div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
							<div className="w-12 h-12 rounded-xl bg-zinc-900/80 border border-zinc-800/50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-inner">
								<img
									src="https://cdn.simpleicons.org/github/f4f4f5"
									alt="GitHub Logo"
							...
							<div>
								<h3 className="text-sm font-bold text-zinc-100 group-hover:text-zinc-50 transition-colors">
									Interested in the code?
								</h3>
								<p className="text-xs text-zinc-500 mt-1 leading-relaxed max-w-md">
									Check out the source code, structure, and implementation details for this React
						...
						<a
							...
							target="_blank"
							rel="noreferrer"
							className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-zinc-900 border border-zinc-800 hover:border-amber-500/30 hover:bg-zinc-800/50 text-xs font-bold text-zinc-200 hover:text-amber-400 transition-all duration-300 cursor-pointer shadow-md"
						>
