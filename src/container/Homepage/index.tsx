	...
	return (
		<div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col justify-between relative overflow-hidden">
			...
			<main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-16 flex flex-col justify-center">
				...
				{/* Simple minimal GitHub link */}
				<div className="mt-12 text-center">
					<a
						href="https://github.com/jtnqr/JDT-17-JULIUS-REACT"
						target="_blank"
						rel="noreferrer"
						className="inline-flex items-center gap-2 text-zinc-500 hover:text-zinc-300 text-xs font-bold transition-all cursor-pointer group"
					>
						<img
							src="https://cdn.simpleicons.org/github/71717a"
							alt=""
							className="h-3.5 w-3.5 object-contain filter hover:brightness-125 transition-all group-hover:scale-105"
							loading="lazy"
						/>
